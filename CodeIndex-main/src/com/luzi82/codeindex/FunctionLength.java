...
public class FunctionLength extends Case {
	...
	public void test_00001_speed(Object arg) {
		...
		msg(String.format("test_00001_speed: %s lines", metricPrefix(donePerSec)));
	}
	...
	public void test_00010_speed(Object arg) {
		...
		msg(String.format("test_00010_speed: %s lines", metricPrefix(donePerSec)));
	}
	...
	public void test_00100_speed(Object arg) {
		...
		msg(String.format("test_00100_speed: %s lines", metricPrefix(donePerSec)));
	}
	...
	public void test_01000_speed(Object arg) {
		...
		msg(String.format("test_01000_speed: %s lines", metricPrefix(donePerSec)));
	}
	...
	public void test_10000_speed(Object arg) {
		...
		msg(String.format("test_10000_speed: %s lines", metricPrefix(donePerSec)));
	}
...
//		msg(String.format("test_20000_speed: %s lines", metricPrefix(donePerSec)));
//	}
